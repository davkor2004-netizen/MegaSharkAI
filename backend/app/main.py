...
async def startup_event():
    ...
    Здесь можно инициализировать подключения к БД, Redis и другим сервисам.
    """
    ...
    try:
        from app.services.email import email_service as global_email_service
...
async def shutdown_event():
    ...
    Здесь нужно корректно закрыть подключения к внешним сервисам.
    """
