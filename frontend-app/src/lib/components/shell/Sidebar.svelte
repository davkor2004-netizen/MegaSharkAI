<script lang="ts">
  ...
  import { ADMIN_NAV, getNavGroups, isNavItemActive, type AppNavItem } from '$lib/navigation/app-nav';
...
>
  ...
  <div class="mb-6 flex items-center gap-3 px-1">
    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="truncate text-[11px] text-muted-foreground">Командный центр</p>
    </div>
  </div>
